...
describe('Turn', function() {
  ...
  it('should store an object of the current card in play', function() {
    const card = new Card(
      1, 
      `What allows you to define a set of related information using 
      key-value pairs?`, 
  ...
  it(`should return a boolean indicating if user guess matches 
  card correct answer`, function() {
    const card = new Card(
      1, `What allows you to define a set of related information using 
      key-value pairs?`, 
      ['object', 'array', 'function'], 
      'object');
    const turn = new Turn('User Guess', card);
